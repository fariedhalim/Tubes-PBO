...
class Player(char):
  def __init__(self, player, x, y, flip, data, sprite, animation_steps, sound):
    super().__init__(player, flip)
    self.size = data[0]
    self.image_scale = data[1]
    self.offset = data[2]
    self.animation_list = self.load_images(sprite, animation_steps)
